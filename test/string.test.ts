import { addComma } from "../src/common/utils/string-utils";

describe("[string-utils:콤마_추가]", () => {
  ...
  it("10000000000", () => expect(addComma(10000000000)).toEqual("10,000,000,000"));
  it("100000000000", () => expect(addComma(100000000000)).toEqual("100,000,000,000"));
  it("1000000000000", () => expect(addComma(1000000000000)).toEqual("1,000,000,000,000"));
  it("10000000000000", () => expect(addComma(10000000000000)).toEqual("10,000,000,000,000"));
});
